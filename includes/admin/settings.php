...
{
    $cbseLinks = array(
        '<a href="' . admin_url('options-general.php?page=course_booking_system_extension') . '">' . __('Settings', 'course_booking_system_extension') . '</a>',
    );
...
{
    add_options_page(__('Course Booking System Extension', 'course_booking_system_extension'), __('Course Booking System Extension', 'course_booking_system_extension'), 'manage_options', 'course_booking_system_extension', 'cbse_render_settings_page');
}
...
function cbse_render_settings_page()
{
    ...
    <div class="wrap">
        ...
        <?php settings_errors(); ?>
        <h2><?php _e('Course Booking System Extension', 'course-booking-system-extension'); ?></h2>
