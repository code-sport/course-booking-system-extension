    ...
    <table class="form-table">
        <tr>
            ...
            <td>
                ...
                $selected = get_the_author_meta( 'covid-19-status', $user->ID ); //there was an extra ) here that was not needed
                ?>
                <select name="covid-19-status" id="covid-19-status">
                    <option value="tested" <?php echo ($selected == "tested")?  'selected="selected"' : '' ?>><?php _e('tested') ?></option>
                    <option value="vaccinated" <?php echo ($selected == "vaccinated")?  'selected="selected"' : '' ?>><?php _e('vaccinated') ?></option>
                    <option value="recovered" <?php echo ($selected == "recovered")?  'selected="selected"' : '' ?>><?php _e('recovered') ?></option>
                    <option value="unknown" <?php echo (empty($selected) || $selected == "unknown")?  'selected="selected"' : '' ?>><?php _e('unknown') ?></option>
                </select><br />
        ...
        <tr>
            ...
            <td>
                ...
                ?>
                <input type="date" name="covid-19-status_date" id="covid-19-status_date" value="<?php echo $saved; ?>" class="regular-text"  placeholder="YYYY-MM-DD"/><br />
